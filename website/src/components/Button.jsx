...
export default function Button({
    ...
    const variants = {
        ...
        'primary-warm': 'bg-candi-accent-warm text-candi-accent-strong hover:opacity-80',
        'primary-hot': 'bg-candi-accent-hot text-candi-on-accent hover:opacity-90 shadow-hygge',
        ...
        'secondary-warm': 'bg-candi-secondary-warm text-candi-secondary-strong hover:opacity-80',
        'secondary-hot': 'bg-candi-secondary-hot text-candi-on-secondary hover:opacity-90 shadow-hygge',
        ...
        'success-warm': 'bg-candi-success-warm text-candi-success-strong hover:opacity-80',
        'success-hot': 'bg-candi-success-hot text-candi-on-success hover:opacity-90 shadow-hygge',
        ...
        'error-warm': 'bg-candi-error-warm text-candi-error-strong hover:opacity-80',
        'error-hot': 'bg-candi-error-hot text-candi-on-error hover:opacity-90 shadow-hygge',
        ...
        'warning-warm': 'bg-candi-warning-warm text-candi-warning-strong hover:opacity-80',
        'warning-hot': 'bg-candi-warning-hot text-candi-on-warning hover:opacity-90 shadow-hygge',
        ...
        'info-warm': 'bg-candi-info-warm text-candi-info-strong hover:opacity-80',
        'info-hot': 'bg-candi-info-hot text-candi-on-info hover:opacity-90 shadow-hygge',
