...
function generateKonsoleTheme(name, mode, colors) {
    ...
    // Primitive colors
    const red = hexToRgb(colors.red || colors.terminalRed);
    const blue = hexToRgb(colors.blue || colors.terminalBlue);
    const green = hexToRgb(colors.green || colors.terminalGreen);
    const yellow = hexToRgb(colors.yellow || colors.terminalYellow);
    const magenta = hexToRgb(colors.magenta || colors.terminalMagenta);
    const cyan = hexToRgb(colors.cyan || colors.terminalCyan);
    const teal = hexToRgb(colors.teal || colors.terminalCyan);
    const pink = hexToRgb(colors.pink || colors.terminalMagenta);
    const gold = hexToRgb(colors.gold || colors.terminalYellow);
    const silver = hexToRgb(colors.silver || colors.textMuted);
...
[Candi]
# Primitive colors for custom theming reference
Red=${red.r},${red.g},${red.b}
Blue=${blue.r},${blue.g},${blue.b}
Green=${green.r},${green.g},${green.b}
Yellow=${yellow.r},${yellow.g},${yellow.b}
Magenta=${magenta.r},${magenta.g},${magenta.b}
Cyan=${cyan.r},${cyan.g},${cyan.b}
Teal=${teal.r},${teal.g},${teal.b}
Pink=${pink.r},${pink.g},${pink.b}
Gold=${gold.r},${gold.g},${gold.b}
Silver=${silver.r},${silver.g},${silver.b}
`;
}
